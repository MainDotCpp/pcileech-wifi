...
module pcileech_fifo #(
    ...
    reg     [79:0]      _pcie_core_config = { 4'hf, 1'b1, 1'b1, 1'b0, 1'b0, 8'h0c, 16'h8168, 16'h10ec, 16'he000, 16'h1458 };
    ...
    task pcileech_fifo_ctl_initialvalues;               // task is non automatic
        begin
            ...
            rw[143:128] <= 16'h1458;                    // +010: CFG_SUBSYS_VEND_ID (NOT IMPLEMENTED)
            rw[159:144] <= 16'hE000;                    // +012: CFG_SUBSYS_ID      (NOT IMPLEMENTED)
            rw[175:160] <= 16'h10EC;                    // +014: CFG_VEND_ID        (NOT IMPLEMENTED)
            rw[191:176] <= 16'h8168;                    // +016: CFG_DEV_ID         (NOT IMPLEMENTED)
            rw[199:192] <= 8'h0C;                       // +018: CFG_REV_ID         (NOT IMPLEMENTED)
